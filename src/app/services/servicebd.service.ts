...
export class ServicebdService {
  ...
  tablaProductos: string = `CREATE TABLE IF NOT EXISTS productos(id INTEGER PRIMARY KEY AUTOINCREMENT,id_vendedor INTEGER, nombre_producto TEXT NOT NULL, descripcion TEXT, categoria TEXT, estado TEXT, 
    precio REAL NOT NULL, imagenes TEXT, ubicacion TEXT)`;
...
`;
  ...
  async agregarProducto(
    ...
    precio: number,
    imagenes: string[],
    ubicacion: string // nuevo parámetro para la dirección completa
  ): Promise<number | null> {
    ...
    INSERT INTO productos 
      (id_vendedor, nombre_producto, descripcion, categoria, estado, precio, imagenes, ubicacion)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
  `;
